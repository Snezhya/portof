    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center gap-16">
        ...
        <div className="flex-1">
          <h3 className="text-2xl md:text-3xl font-poppins text-hu-gold mb-4" data-animate>Adil Pribadi Abdinusa</h3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="p-4 bg-[rgba(20,10,10,0.5)] border border-[rgba(212,175,55,0.1)] rounded-lg backdrop-blur-sm" data-animate>
          ...
          <p className="text-lg text-gray-300 leading-relaxed mb-6" data-animate>
          ...
          <div className="flex flex-col gap-3 mb-8" data-animate>
          ...
          <a href="#contact" className="inline-block px-8 py-3 bg-hu-red text-white font-poppins font-semibold rounded-lg shadow-[0_0_15px_rgba(107,15,26,0.6)] hover:bg-hu-glow hover:shadow-[0_0_25px_rgba(217,56,58,0.7)] hover:-translate-y-1 transition-all" data-animate>
            Let's Talk
          </a>
        </div>
      </div>
