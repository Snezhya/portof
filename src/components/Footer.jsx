...
const Footer = () => {
  ...
  return (
    <footer 
      ref={footerRef} 
      className="py-10 border-t border-[rgba(212,175,55,0.15)] bg-hu-bg-light relative text-center z-10"
    >
      <button 
        onClick={scrollToTop} 
      ...
      <p className="text-gray-500 text-sm font-poppins mt-4" data-animate>
